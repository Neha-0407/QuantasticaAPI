...
# The ADK will automatically pick up the n_agentecessary credentials and settings.
load_dotenv()

# Instantiate the in-memory service to be shared across agents
...
root_agent = Agent(
    ...
    # Sub-agents are now passed as a list of AgentTools
    tools=[
    ...
    # Provide the service to the agent and its sub-agents
