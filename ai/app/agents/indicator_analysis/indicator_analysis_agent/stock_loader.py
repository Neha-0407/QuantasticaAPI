...
def load_stock_data(json_file_path:str, symbol:str):
    """
...
#     stock_file = "stock_indicators.json"
#     stock_symbol = "META"
#     stock_info = load_stock_data(stock_file, stock_symbol)
#     if stock_info:
#         print(json.dumps(stock_info, indent=2))
#     else:
#         print(f"Stock symbol {stock_symbol} not found in {stock_file}.")